...
int main(int argc, char **argv)
{
    ...
    case 4:{
        ...
        struct frequency_pair alphabet_frequencies[] = {
                {.letter = 'a', .frequency = 4.72486305f},
                {.letter = 'b', .frequency = 1.21002591f},
                {.letter = 'c', .frequency = 2.88101411f},
                {.letter = 'd', .frequency = 2.62172294f},
                {.letter = 'e', .frequency = 9.82425785f},
                {.letter = 'f', .frequency = 2.56410265f},
                {.letter = 'g', .frequency = 1.99f},
                {.letter = 'h', .frequency = 3.77412844f},
                {.letter = 'i', .frequency = 7.60587740f},
                {.letter = 'j', .frequency = 0.16f},
                {.letter = 'k', .frequency = 0.41f},
                {.letter = 'l', .frequency = 2.62172294f},
                {.letter = 'm', .frequency = 2.43f},
                {.letter = 'n', .frequency = 7.51f},
                {.letter = 'o', .frequency = 7.20253515f},
                {.letter = 'p', .frequency = 2.39124179f},
                {.letter = 'q', .frequency = 0.17f},
                {.letter = 'r', .frequency = 6.28061056f},
                {.letter = 's', .frequency = 5.50273705f},
                {.letter = 't', .frequency = 7.95159912f},
                {.letter = 'u', .frequency = 2.48f},
                {.letter = 'v', .frequency = 1.15f},
                {.letter = 'w', .frequency = 1.29645634f},
                {.letter = 'x', .frequency = 0.23048113f},
                {.letter = 'y', .frequency = 1.78622878f},
                {.letter = 'z', .frequency = 0.05762028f}
        };
        ...
        struct known_pair kp[] = {
                ...
                //{.alphabet_letter = 'i', .text_letter = 'e'},
                //{.alphabet_letter = 'c', .text_letter = 'g'},
                //{.alphabet_letter = 'v', .text_letter = 'x'}
        };

        decipher(text_frequencies, alphabet_frequencies, length, text, strlen(text), kp, ALPHABET_LENGTH);
        printf("%s\n", text);
        for (int i = 0; i < ALPHABET_LENGTH; i++) {
            printf("char - %c, frequency - %.*f\n", text_frequencies[i].letter, 8, text_frequencies[i].frequency);
        }
